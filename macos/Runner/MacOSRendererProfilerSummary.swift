...
enum MacOSRendererProfilerSummary {
  static func log(
    ...
    let summary = String(
      ...
      doubleValue(compositor, "nativeCompositorGpuSubmitCpuP95Ms"),
      doubleValue(compositor, "nativeCompositorGpuCompletionP95Ms"),
      ...
      int64Value(compositor, "nativeCompositorGpuLastImportUs"),
      int64Value(compositor, "nativeCompositorGpuLastPrepareUs"),
      int64Value(compositor, "nativeCompositorGpuLastBindUs"),
      int64Value(compositor, "nativeCompositorGpuLastPassEncodeUs"),
      int64Value(compositor, "nativeCompositorGpuLastSubmitUs"),
      int64Value(compositor, "nativeCompositorGpuLastCpuRenderUs"),
      int64Value(compositor, "nativeCompositorGpuDestinationImportCount"),
      int64Value(compositor, "nativeCompositorGpuDestinationImportReuseCount"),
      int64Value(compositor, "nativeCompositorGpuSourceImportCount"),
      int64Value(compositor, "nativeCompositorGpuSourceImportReuseCount"),
      int64Value(compositor, "nativeCompositorGpuImportedTextureCacheSize"),
      int64Value(compositor, "nativeCompositorGpuImportedTextureCacheEvictionCount"),
      int64Value(compositor, "nativeCompositorGpuFinalBindingCreateCount"),
      int64Value(compositor, "nativeCompositorGpuOverlayBindGroupCreateCount"),
      int64Value(compositor, "nativeCompositorGpuOverlayLayerRebuildCount"),
      int64Value(compositor, "nativeCompositorGpuOverlayLayerReuseCount")
    )
