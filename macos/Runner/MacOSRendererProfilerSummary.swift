...
enum MacOSRendererProfilerSummary {
  static func log(
    ...
    let summary = String(
      ...
      int64Value(compositor, "nativeCompositorBackendLastImportUs"),
      int64Value(compositor, "nativeCompositorBackendLastPrepareUs"),
      int64Value(compositor, "nativeCompositorBackendLastBindGroupUs"),
      int64Value(compositor, "nativeCompositorBackendLastPassEncodeUs"),
      int64Value(compositor, "nativeCompositorBackendLastSubmitUs"),
      int64Value(compositor, "nativeCompositorBackendLastCpuRenderUs"),
      int64Value(compositor, "nativeCompositorBackendDestinationImportCount"),
      int64Value(compositor, "nativeCompositorBackendDestinationImportReuseCount"),
      int64Value(compositor, "nativeCompositorBackendSourceImportCount"),
      int64Value(compositor, "nativeCompositorBackendSourceImportReuseCount"),
      int64Value(compositor, "nativeCompositorBackendImportedTextureCacheSize"),
      int64Value(compositor, "nativeCompositorBackendImportedTextureCacheEvictionCount"),
      int64Value(compositor, "nativeCompositorBackendFinalBindGroupCreateCount"),
      int64Value(compositor, "nativeCompositorBackendOverlayBindGroupCreateCount"),
      int64Value(compositor, "nativeCompositorBackendOverlayLayerRebuildCount"),
      int64Value(compositor, "nativeCompositorBackendOverlayLayerReuseCount")
    )
