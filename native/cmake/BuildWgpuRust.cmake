if(NOT DEFINED VOID_CARGO_EXECUTABLE OR NOT EXISTS "${VOID_CARGO_EXECUTABLE}")
    message(FATAL_ERROR "VOID_CARGO_EXECUTABLE is missing")
endif()
...
execute_process(
    COMMAND "${CMAKE_COMMAND}" -E env
            ...
            RUSTUP_DIST_SERVER=
            RUSTUP_UPDATE_ROOT=
            "${VOID_CARGO_EXECUTABLE}" ${_cargo_args}
