    ...
    switch (action) {
      ...
      case DebugNativeTimingAction():
        ...
        log.info(
          ...
          'flutterSurfaceSourceChanges=${value('rendererOwnedFlutterSurfaceSourceChangeCount')} '
          'flutterSurfaceAwaitFirst=${value('rendererOwnedFlutterSurfaceAwaitFirstCount')} '
          'viewportAwaitFirst=${value('rendererOwnedViewportAwaitFirstCount')} '
          ...
          'layerFirstPresented=${value('rendererOwnedLayerFirstPresented')} '
          'layerFirstViewport=${value('rendererOwnedLayerFirstPresentViewportLeftPermille')},'
          '${value('rendererOwnedLayerFirstPresentViewportTopPermille')},'
          '${value('rendererOwnedLayerFirstPresentViewportRightPermille')},'
          '${value('rendererOwnedLayerFirstPresentViewportBottomPermille')} '
          'layerViewportReady=${value('rendererOwnedLayerViewportRectReady')} '
          'layerViewportBlocked=${value('rendererOwnedLayerFirstPresentBlockedUntilViewportCount')} '
          'layerPending=${value('rendererOwnedLayerPendingDrawableCount')} '
          'layerPublished=${value('rendererOwnedLayerLastPublishedUploadCount')} '
