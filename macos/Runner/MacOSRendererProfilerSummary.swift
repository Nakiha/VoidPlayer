...
enum MacOSRendererProfilerSummary {
  static func log(
    ...
    let summary = String(
      ...
      int64Value(perf, "sourceFrameStaleCompletionDropCount"),
      int64Value(perf, "sourceFrameCacheHitRatioX1000"),
      int64Value(texture, "rendererTargetRebuildCount"),
      int64Value(texture, "rendererTargetAllocationCount"),
      int64Value(texture, "rendererTargetRebuildReuseCount"),
      int64Value(texture, "rendererTargetRebuildLastAllocatedCount"),
      int64Value(texture, "rendererTargetRebuildLastReusedCount"),
      doubleValue(texture, "rendererTargetRebuildLastDurationMs"),
      int64Value(texture, "rendererTargetRetiredCount"),
      int64Value(texture, "rendererTargetPrewarmRequestCount"),
      int64Value(texture, "rendererTargetPrewarmReadyCount"),
      int64Value(texture, "rendererTargetPrewarmHitCount"),
      int64Value(texture, "rendererTargetPrewarmDroppedCount"),
