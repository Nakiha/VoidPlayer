...
```bash
# 基本播放测试
python run_player.py -i resources/video/NovosobornayaSquare_1920x1080.mp4 --auto-play

# 多轨道测试
python run_player.py -i resources/video/NovosobornayaSquare_1920x1080.mp4 -i resources/video/TheaterSquare_1920x1080.mp4 --auto-play
