...
Windows native presentation is reserved/fail-closed on this branch. D3D11/DX12
decode and presentation requirements should be documented again when the Windows
runner-composed backend is rebuilt.
