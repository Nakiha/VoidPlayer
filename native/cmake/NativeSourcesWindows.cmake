...
set(VOID_RENDERER_WINDOWS_SOURCES
    ...
    "${VOID_NATIVE_DIR}/renderer/renderer_d3d_compat.cpp"
...
if(BUILD_ANALYSIS)
    list(APPEND VOID_RENDERER_WINDOWS_SOURCES
        ...
        "${VOID_NATIVE_DIR}/renderer/overlay/analysis_overlay_renderer.cpp")
else()
    list(APPEND VOID_RENDERER_WINDOWS_SOURCES
        "${VOID_NATIVE_DIR}/renderer/overlay/analysis_overlay_renderer_stub.cpp")
endif()
