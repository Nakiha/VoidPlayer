...
| --- | --- | --- | --- | --- | --- | --- |
| FFmpeg runtime/dev package | FFmpeg `n8.1`, pinned by `toolchains/ffmpeg.lock.json` | `https://github.com/Nakiha/VoidPlayer-FFmpeg-Build` | GPL v3 package, see hydrated package license files | `.toolchains/ffmpeg/windows-x64` and `.toolchains/ffmpeg/macos-arm64` | demux, decode, D3D11VA, VideoToolbox, hwdownload, swresample | Update `toolchains/ffmpeg.lock.json`, restore scripts, and package metadata together; do not commit hydrated SDK files. |
