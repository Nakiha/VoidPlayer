    ...
    switch (action) {
      ...
      case DebugNativeTimingAction():
        ...
        log.info(
          ...
          'sourceReady=${value('sourceReady')} '
          'sourceRequiredMask=${value('sourceRequiredMask')} '
          'sourceDrawnMask=${value('sourceDrawnMask')} '
          'sourceMissingMask=${value('sourceMissingMask')} '
