...
- [ ] 将 FFI flat diagnostics 聚合进 `NativeDiagnosticsProvider`，并消除 process-global player registry 或收口到 plugin instance。
...
- [ ] 给 Renderer shutdown during seek/capture/resize 增加 smoke/stress。
